...
import stylesCss from 'themes/divers-logbook/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_divers-logbook_componentCss']) {
    
    document['_vaadintheme_divers-logbook_componentCss'] = true;
  }
